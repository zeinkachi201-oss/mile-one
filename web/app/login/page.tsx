...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-night flex items-center justify-center px-4">
      ...
      <div className="absolute bottom-1/4 right-1/3 w-60 h-60 bg-emerald-600/10 rounded-full blur-3xl pointer-events-none" />
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="glass rounded-2xl p-8">
          ...
          <p className="text-center text-slate-500 mt-6 text-sm">
            No account?{' '}
            <Link href="/signup" className="text-brand font-bold hover:text-indigo-300 transition">
              Sign up free
            </Link>
          </p>
        </div>
